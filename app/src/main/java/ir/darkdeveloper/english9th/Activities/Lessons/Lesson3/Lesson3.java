package ir.darkdeveloper.english9th.Activities.Lessons.Lesson3;
...
import ir.darkdeveloper.english9th.Adapters.RecyclerAdapters.Lessons.AdapterLesson3;
...
public class Lesson3 extends AppCompatActivity {
    public static ArrayList<DataBaseStructure> lesson3 = new ArrayList<>();
    ...
    public static String findit, findit2;
    ...
    private void recyclerView() {
        ...
        for (int i = 0; i <= 6; i++) {
            ...
            contactLessons.fileName = dataRecyclerLess.fileName3[i];
            lessonsList.add(contactLessons);
        }
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new AdapterLesson3(getBaseContext(), lessonsList));
    }
    ...
    private void select_lesson3() {
        try (Cursor cursor = MainActivity.database.rawQuery("SELECT * FROM lessons WHERE _id = 3",
                null)) {
