package ir.darkdeveloper.english9th.Activities.Lessons.Lesson2;
...
import ir.darkdeveloper.english9th.Adapters.RecyclerAdapters.Lessons.AdapterLesson2;
...
public class Lesson2 extends AppCompatActivity {
    public static ArrayList<DataBaseStructure> lesson2 = new ArrayList<>();
    ...
    private void recyclerView() {
        ...
        for (int i = 0; i <= 6; i++) {
            ...
            contactLessons.fileName = dataRecyclerLess.fileName2[i];
            lessonsList.add(contactLessons);
        }
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new AdapterLesson2(getBaseContext(), lessonsList));
    }
