package ir.darkdeveloper.english9th.Activities.Lessons.Lesson6;
...
import ir.darkdeveloper.english9th.Adapters.RecyclerAdapters.Lessons.AdapterLesson6;
...
public class Lesson6 extends AppCompatActivity {
    public static ArrayList<DataBaseStructure> lesson6 = new ArrayList<>();
    ...
    private void recyclerView() {
        ...
        for (int i = 0; i <= 6; i++) {
            ...
            contactLessons.fileName = dataRecyclerLess.fileName6[i];
            lessonsList.add(contactLessons);
        }
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new AdapterLesson6(getBaseContext(), lessonsList));
    }
    ...
    private void select_lesson6() {
        try (Cursor cursor = MainActivity.database.rawQuery("SELECT * FROM lessons WHERE _id = 6",
                null)) {
