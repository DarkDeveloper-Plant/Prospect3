package ir.darkdeveloper.english9th.Activities.Lessons.Lesson4;
...
import ir.darkdeveloper.english9th.Adapters.RecyclerAdapters.Lessons.AdapterLesson4;
...
public class Lesson4 extends AppCompatActivity {
    public static ArrayList<DataBaseStructure> lesson4 = new ArrayList<>();
    ...
    private void recyclerView() {
        ...
        for (int i = 0; i <= 6; i++) {
            ...
            contactLessons.fileName = dataRecyclerLess.fileName4[i];
            lessonsList.add(contactLessons);
        }
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(new AdapterLesson4(getBaseContext(), lessonsList));
    }
