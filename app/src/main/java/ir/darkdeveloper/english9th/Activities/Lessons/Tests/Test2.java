...
public class Test2 extends AppCompatActivity {
    ...
    private RadioButton radio1_1, radio1_2, radio1_3, radio1_4, radio1_5, radio1_6, radio2_1, radio2_2, radio2_3, radio2_4, radio2_5, radio2_6, radio2_7, radio2_8, radio2_9, radio2_10, radio2_11, radio2_12;
    ...
    public void onBackPressed() {
        startActivity(new Intent(Test2.this, TestMain.class));
        finish();
    }
    ...
    private void sets() {
        ...
        tv1.setText("We can't exchange dollar to rial.");
        tv2.setText("Before you get a room, you should check in.");
        tv3.setText("You use ticket for public services.");

        tv4.setText("I am ..... breakfast.");
        radio2_1.setText("eat");
        radio2_2.setText("have");
        radio2_3.setText("has");
        radio2_4.setText("having");

        tv5.setText("Who is .... English.");
        radio2_5.setText("speaks");
        radio2_6.setText("speak");
        radio2_7.setText("speaking");
        radio2_8.setText("to speak");

        tv6.setText("Kate..... hat is beautiful.");
        radio2_9.setText("s");
        radio2_10.setText("'s");
        radio2_11.setText("s'");
        radio2_12.setText("'");

        img1.setImageResource(R.drawable.ticket);
        img2.setImageResource(R.drawable.exchangemoney);
        img3.setImageResource(R.drawable.checktimetable);
    }
    ...
    private void check() {
        ...
        if (radio2_4.isChecked()) {
            ...
            wrong4 = "4. Wrong! answer is 'having'\n\n";
        }

        if (radio2_7.isChecked()) {
            correct5 = "5. correct\n\n";
        } else {
            wrong5 = "5. Wrong! answer is 'speaking'\n\n";
        }

        if (radio2_10.isChecked()) {
            correct6 = "6. correct\n\n";
        } else {
            wrong6 = "6. Wrong! answer is ' 's '\n\n";
        }


        if ((ed1.getText().toString().equals("Buy a ticket") || ed1.getText().toString().equals("buy a ticket")
                || ed1.getText().toString().equals("Buy a ticket  ") || ed1.getText().toString().equals("buy a ticket "))
                || ed1.getText().toString().equals("Buying a ticket ") || ed1.getText().toString().equals("buying a ticket")) {
            correct7 = "7. correct\n\n";
        } else {
            wrong7 = "7. Wrong! answer is 'Buying a ticket'\n\n";
        }


        if ((ed2.getText().toString().equals("Exchange money") || ed2.getText().toString().equals("Exchange money ")
                || ed2.getText().toString().equals("exchange money") || ed2.getText().toString().equals("exchange money "))
                || ed2.getText().toString().equals("Exchanging money") || ed2.getText().toString().equals("exchanging money")) {
            correct8 = "8. correct\n\n";
        } else {
            wrong8 = "8. Wrong! answer is 'Exchanging money'\n\n";
        }


        if ((ed3.getText().toString().equals("Check timetable") || ed3.getText().toString().equals("Check timetable ")
                || ed3.getText().toString().equals("check timetable") || ed3.getText().toString().equals("check timetable "))
                || ed3.getText().toString().equals("checking timetable") || ed3.getText().toString().equals("Checking timetable ")) {
            correct9 = "9. correct\n";
        } else {
            wrong9 = "9. Wrong! answer is 'Checking timetable'\n";
        }
        ...
        final AlertDialog dialog = new AlertDialog.Builder(Test2.this)
                .setCancelable(true)
                .setView(view)
                .create();
