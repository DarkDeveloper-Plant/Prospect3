...
public class Test6 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Test6.this, TestMain.class));
        finish();
    }
    ...
    private void sets() {
        title3.setText("Write kind of illness in the following text boxes.");
        tv1.setText("If you hit your head on a door, you won't feel some pain.");
        tv2.setText("Blood bleeds from humans.");
        tv3.setText("Knife is not keen, it can cut your finger.");

        tv4.setText("She .... her prayers on time 2 hours ago.");
        radio2_1.setText("said");
        radio2_2.setText("say");
        radio2_3.setText("tell");
        radio2_4.setText("says");

        tv5.setText("Did he ..... to school on Saturday?");
        radio2_5.setText("go");
        radio2_6.setText("goes");
        radio2_7.setText("gone");
        radio2_8.setText("went");

        tv6.setText("I don't want to help ....");
        radio2_9.setText("he");
        radio2_10.setText("his");
        radio2_11.setText("him");
        radio2_12.setText("they");

        img1.setImageResource(R.drawable.hehasbruises);
        img2.setImageResource(R.drawable.itsbleeding);
        img3.setImageResource(R.drawable.ihurtmyknee);
    }
    ...
    private void check() {
        ...
        if (radio2_1.isChecked()) {
            ...
            wrong4 = "4. Wrong! answer is 'said'\n\n";
        }

        if (radio2_5.isChecked()) {
            correct5 = "5. correct\n\n";
        } else {
            wrong5 = "5. Wrong! answer is 'go'\n\n";
        }

        if (radio2_11.isChecked()) {
            correct6 = "6. correct\n\n";
        } else {
            wrong6 = "6. Wrong! answer is 'him'\n\n";
        }


        if ((ed1.getText().toString().equals("Bruises") || ed1.getText().toString().equals("Bruises ")
                || ed1.getText().toString().equals("bruises") || ed1.getText().toString().equals("bruises ")
                || ed1.getText().toString().equals("bruises") || ed1.getText().toString().equals("bruises"))) {
            correct7 = "7. correct\n\n";
        } else {
        ...
        if ((ed2.getText().toString().equals("Bleed blood") || ed2.getText().toString().equals("Bleed blood ")
                || ed2.getText().toString().equals("bleed blood") || ed2.getText().toString().equals("bleed blood "))
                || ed2.getText().toString().equals("Bleeding blood") || ed2.getText().toString().equals("bleeding blood")) {
            correct8 = "8. correct\n\n";
        } else {
            wrong8 = "8. Wrong! answer is 'Bleeding blood'\n\n";
        }


        if ((ed3.getText().toString().equals("Hurt a knee") || ed3.getText().toString().equals("Hurt a knee ")
                || ed3.getText().toString().equals("hurt a knee") || ed3.getText().toString().equals("hurt a knee "))
                || ed3.getText().toString().equals("Hurting a knee") || ed3.getText().toString().equals("hurting a knee")) {
            correct9 = "9. correct\n";
        } else {
            wrong9 = "9. Wrong! answer is 'Hurting a knee'\n";
        }
        ...
        final AlertDialog dialog = new AlertDialog.Builder(Test6.this)
                .setCancelable(true)
                .setView(view)
                .create();
