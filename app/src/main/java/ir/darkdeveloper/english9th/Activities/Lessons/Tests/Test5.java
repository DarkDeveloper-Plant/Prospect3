...
public class Test5 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Test5.this, TestMain.class));
        finish();
    }
    ...
    private void sets() {
        ...
        tv1.setText("Every website on the internet has own address.");
        tv2.setText("You can't text a message with a cellphone.");
        tv3.setText("IT doesn't equal information technology.");

        tv4.setText("She .... up late last day.");
        radio2_1.setText("wakes");
        radio2_2.setText("wake");
        radio2_3.setText("waked");
        radio2_4.setText("woke");

        tv5.setText("Did you ..... your homework?");
        radio2_5.setText("do");
        radio2_6.setText("did");
        radio2_7.setText("does");
        radio2_8.setText("doing");

        tv6.setText("We ..... blue yesterday.");
        radio2_9.setText("was");
        radio2_10.setText("are");
        radio2_11.setText("were");
        radio2_12.setText("is");

        img1.setImageResource(R.drawable.interviewsomebody);
        img2.setImageResource(R.drawable.updateablog);
        img3.setImageResource(R.drawable.participateonline);
    }
    ...
    private void check() {
        ...
        if (radio2_4.isChecked()) {
            correct4 = "4. correct\n\n";
        } else {
            wrong4 = "4. Wrong! answer is 'woke'\n\n";
        }

        if (radio2_5.isChecked()) {
            correct5 = "5. correct\n\n";
        } else {
            wrong5 = "5. Wrong! answer is 'do'\n\n";
        }

        if (radio2_11.isChecked()) {
            correct6 = "6. correct\n\n";
        } else {
            wrong6 = "6. Wrong! answer is 'were'\n\n";
        }


        if ((ed1.getText().toString().equals("Interview somebody") || ed1.getText().toString().equals("Interview somebody ")
                || ed1.getText().toString().equals("interview somebody") || ed1.getText().toString().equals("interview somebody ")
                || ed1.getText().toString().equals("Interviewing somebody") || ed1.getText().toString().equals("interviewing somebody"))) {
            correct7 = "7. correct\n\n";
        } else {
            wrong7 = "7. Wrong! answer is 'Interviewing somebody'\n\n";
        }


        if ((ed2.getText().toString().equals("Update a blog") || ed2.getText().toString().equals("Update a blog ")
                || ed2.getText().toString().equals("update a blog") || ed2.getText().toString().equals("update a blog "))
                || ed2.getText().toString().equals("Updating a blog") || ed2.getText().toString().equals("updating a blog")) {
            correct8 = "8. correct\n\n";
        } else {
            wrong8 = "8. Wrong! answer is 'Updating a blog'\n\n";
        }


        if ((ed3.getText().toString().equals("Participate in an online course") || ed3.getText().toString().equals("Participate in an online course ")
                || ed3.getText().toString().equals("participate in an online course") || ed3.getText().toString().equals("participate in an online course "))
                || ed3.getText().toString().equals("Participating in an online course") || ed3.getText().toString().equals("participating in an online course")) {
            correct9 = "9. correct\n";
        } else {
            wrong9 = "9. Wrong! answer is 'Participating in an online course'\n";
        }
        ...
        final AlertDialog dialog = new AlertDialog.Builder(Test5.this)
                .setCancelable(true)
                .setView(view)
                .create();
