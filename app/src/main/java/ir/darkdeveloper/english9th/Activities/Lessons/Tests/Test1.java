...
public class Test1 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Test1.this, TestMain.class));
        finish();
    }
    ...
    private void sets() {
        tv1.setText("Israel forces are cruel.");
        tv2.setText("Talented student is neat.");
        tv3.setText("Brave person scares everything.");

        tv4.setText("Everybody ..... her.");
        radio2_1.setText("like");
        radio2_2.setText("likes");
        radio2_3.setText("is like");
        radio2_4.setText("is likes");

        tv5.setText("Zahra .... clever.");
        radio2_5.setText("am");
        radio2_6.setText("are");
        radio2_7.setText("is");
        radio2_8.setText("were");

        tv6.setText("Iranian people ..... kind.");
        radio2_9.setText("are");
        radio2_10.setText("was");
        radio2_11.setText("is");
        radio2_12.setText("will");

        img1.setImageResource(R.drawable.angry);
        img2.setImageResource(R.drawable.funny);
        img3.setImageResource(R.drawable.nervous);
    ...
    private void check() {
        ...
        if (radio2_2.isChecked()) {
            correct4 = "4. correct\n\n";
        } else {
            wrong4 = "4. Wrong! answer is 'likes'\n\n";
        }

        if (radio2_7.isChecked()) {
            correct5 = "5. correct\n\n";
        } else {
            wrong5 = "5. Wrong! answer is 'is'\n\n";
        }

        if (radio2_9.isChecked()) {
            correct6 = "6. correct\n\n";
        } else {
            wrong6 = "6. Wrong! answer is 'are'\n\n";
        }


        if ((ed1.getText().toString().equals("angry") || ed1.getText().toString().equals("Angry")
                || ed1.getText().toString().equals("angry ") || ed1.getText().toString().equals("Angry "))) {
            correct7 = "7. correct\n\n";
        } else {
            wrong7 = "7. Wrong! answer is 'angry'\n\n";
        }


        if ((ed2.getText().toString().equals("funny") || ed2.getText().toString().equals("funny ")
                || ed2.getText().toString().equals("Funny") || ed2.getText().toString().equals("Funny "))) {
            correct8 = "8. correct\n\n";
        } else {
            wrong8 = "8. Wrong! answer is 'funny'\n\n";
        }


        if ((ed3.getText().toString().equals("nervous") || ed3.getText().toString().equals("nervous ")
                || ed3.getText().toString().equals("Nervous") || ed3.getText().toString().equals("Nervous "))) {
            correct9 = "9. correct\n";
        } else {
            wrong9 = "9. Wrong! answer is 'nervous'\n";
        }
        ...
        final AlertDialog dialog = new AlertDialog.Builder(Test1.this)
                .setCancelable(true)
                .setView(view)
                .create();
